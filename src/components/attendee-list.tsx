                    ...
                    <thead>
                        <tr className='border-b border-white/10'>
                            <TableHeader style={{ width: 48}}>
                                <input type="checkbox" className='size-4 bg-black rounded border-white/10'/>
                            </TableHeader>
                        ...
                        return(
                            ...
                            <TableCell>
                                <div className='flex flex-col gap-1 '>
                                    <span className='font-semibold text-white'>{attendee.name}
                                    </span>
                                    <span>{attendee.email}
                                    </span>
                                </div>
                    ...
                    <tfoot>
                        <tr>
                            <TableCell className='py-3 px-4 text-sm font-semibold text-left'
                             colSpan={3}>{attendees.length} de {total} itens</TableCell>
